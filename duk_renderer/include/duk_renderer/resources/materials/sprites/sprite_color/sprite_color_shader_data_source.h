#ifndef DUK_RENDERER_SPRITE_COLOR_SHADER_DATA_SOURCE_H
#define DUK_RENDERER_SPRITE_COLOR_SHADER_DATA_SOURCE_H

#include <duk_rhi/pipeline/shader_data_source.h>

namespace duk::renderer {

class SpriteColorShaderDataSource : public duk::rhi::ShaderDataSource {
public:
    SpriteColorShaderDataSource();
...
#endif // DUK_RENDERER_SPRITE_COLOR_SHADER_DATA_SOURCE_H
