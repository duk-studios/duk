...
Texture::Texture() : Texture(duk::resource::Id(0), kDefaultTextureSampler) {
}

Texture::Texture(const ImageResource& image) : Texture(image, kDefaultTextureSampler) {
}

Texture::Texture(const ImageResource& image, const rhi::Sampler& sampler) : m_image(image),
                                                                            m_sampler(sampler) {
}
