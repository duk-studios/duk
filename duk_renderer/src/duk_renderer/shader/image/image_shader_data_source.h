#ifndef DUK_GENERATED_IMAGE_SHADER_DATA_SOURCE_H
#define DUK_GENERATED_IMAGE_SHADER_DATA_SOURCE_H
...
class ImageShaderDataSource : public duk::rhi::ShaderDataSource {
public:
...
#endif// DUK_GENERATED_IMAGE_SHADER_DATA_SOURCE_H
