...
bool is_builtin_glsl_type(const std::string& glslTypeName) {
    static auto builtinGlslTypeNameSet = []() -> std::unordered_set<std::string> {
        return {"int",    "uint",   "float",  "double", "vec2",   "vec3",   "vec4",   "dvec2",  "dvec3",   "dvec4",   "uvec2",   "uvec3",   "uvec4",   "ivec2",   "ivec3",   "ivec4",   "mat2x2",
                "mat2x3", "mat2x4", "mat3x2", "mat3x3", "mat3x4", "mat4x2", "mat4x3", "mat4x4", "dmat2x2", "dmat2x3", "dmat2x4", "dmat3x2", "dmat3x3", "dmat3x4", "dmat4x2", "dmat4x3", "dmat4x4"};
    }();
