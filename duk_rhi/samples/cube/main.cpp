...
int main() {
    ...
    shaderSourceCreateInfo.vertexShaderCode = shaderCompiler.compile(kVertexGlsl, duk::rhi::ShaderModule::VERTEX, "cube.vert").value();
    shaderSourceCreateInfo.fragmentShaderCode = shaderCompiler.compile(kFragmentGlsl, duk::rhi::ShaderModule::FRAGMENT, "cube.frag").value();
    ...
    while (running) {
        ...
        ubo.view = glm::lookAt(glm::vec3(0.0f, 2.0f, 4.0f), // eye
