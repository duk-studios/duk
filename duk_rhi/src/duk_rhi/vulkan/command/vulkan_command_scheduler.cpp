...
VulkanCommandScheduler::VulkanCommandScheduler(const VulkanCommandSchedulerCreateInfo& commandSchedulerCreateInfo) : m_device(commandSchedulerCreateInfo.device),
...
VulkanCommandScheduler::CommandNode::CommandNode(FutureCommand&& futureCommand) noexcept : m_futureCommand(std::move(futureCommand)),
                                                                                           m_command(nullptr) {
}
...
VulkanCommandScheduler::Frame::Frame(const VulkanCommandScheduler::FrameCreateInfo& frameCreateInfo) : m_device(frameCreateInfo.device) {
}
