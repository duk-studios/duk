...
WindowClassEntry::WindowClassEntry(const WindowWin32CreateInfo& windowWin32CreateInfo, const std::string& className) : className(className),
                                                                                                                       windowClass({}),
...
WindowWin32::WindowWin32(const WindowWin32CreateInfo& windowWin32CreateInfo) : Window(windowWin32CreateInfo.windowCreateInfo) {
